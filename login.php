 ...
 $Errors = array();
    if(!empty($_POST)){
        ...
        if (IsNullLogin($Usuario,$Contraseña)) {
			...
			array_push($Errors, "Debe de llenar todos los campos");
        }
        	//$Errors[] = Ingresar($Usuario,$Contraseña);
			array_push($Errors, Ingresar($Usuario, $Contraseña));
               ...
               <h3 class="text-center">Iniciar sesión</h3>
                <form action="<?php $_SERVER['PHP_SELF']?>" method="POST" autocomplete="off">
                    <div class="form-group mt-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Correo Electronico o Usuario"name="Usuario">
                        
                    </div>
                    <div class="form-group mt-5">
                        <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Contraseña" name="Contraseña">
                    </div>
                    <a href="recuperar_contraseña.php" class="justify-conten-end"><small>Olvide mi contraseña?</small></a>
